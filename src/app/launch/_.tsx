...
{
  let Prefix = Env.CDN.static + Env.appAlias + '/@versions/' + Env.CDN.appVer;
  if ( !Env.isProduct ) Prefix = Env.CDN.dev + Env.appAlias;

  tags = [
    ...tags,
    ... [
      {
        tag: 'script',parent : '#__minifyLibCDNSRC',attr: {
        ...
        tag: 'link',parent : '#__minifyLibCDNSRC',attr: {
